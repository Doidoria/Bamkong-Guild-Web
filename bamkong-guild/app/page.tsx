          ...
          <section id="about" className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
              ...
              items={[
                ...
                <>
                  ...
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-amber-50 rounded-md border border-amber-300 mr-1 align-text-bottom relative">
                    {/* ✅ 4. 일반 img 태그를 Next.js Image로 변경 */}
            ...
            <InfoCard 
              ...
              items={[
                ...
                <span className="md:text-[14.5px]">다양한 이벤트와 억압 없는 자유로운 길드를 원하시는 분</span>
              ]}
            />
            <InfoCard 
              title="정중히 거절합니다"
              ...
              items={[
                ...
                <span className="text-stone-800 font-bold md:text-[14.5px]">활동이 너무 적거나 길드원과 소통 노력이 전혀 없으신 분</span>
              ]}
            />
          </section>
          <CallToAction />
