...
const ALBUM_DATA = [
  ...
  { id: 3, images: ['/images/albumgallery/album-3.png', '/images/albumgallery/album-3-sub.png'], title: '비공정 낚시 단체샷', date: '2026.05.20', desc: '드디어 대물 낚은 날 🎣' },
  { id: 4, images: ['/images/albumgallery/album-4.png', '/images/albumgallery/album-4-sub.png'], title: '신규 길드원 환영회', date: '2026.06.11', desc: '새로운 런너님들 앞으로 잘 부탁드려요!' },
  { id: 5, images: ['/images/albumgallery/album-5.png', '/images/albumgallery/album-5-sub.png'], title: '하드코어 클리어', date: '2026.07.08', desc: '몇 번의 도전 끝에 드디어 깼다 ㅠㅠ' },
  { id: 6, images: ['/images/albumgallery/album-6.png', '/images/albumgallery/album-6-sub.png'], title: '새벽 수다 타임', date: '2026.08.15', desc: '잠 안 오는 런너들의 소소한 모임 🌙' },
];
